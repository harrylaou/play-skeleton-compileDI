...
/**
  * Note : this is a a bit different than the application.AppLoader
  * because the appComponents are needed, so it doesn't extend the play.api.ApplicationLoader trait
  */
